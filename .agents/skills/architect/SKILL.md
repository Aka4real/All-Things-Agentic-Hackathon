...
name: architect
description: >-
  Use this skill when operating as @architect (Product Architect & Bounty Strategist). 
  Handles product specification, data modeling, TypeScript/API contracts, and sponsor bounty mapping.
---
