...
export const INITIAL_AGENTS: AgentRegistryItem[] = [
  ...
  },
  {
    ...
    department: 'SecOps',
    description: 'Real-time token sanitizer utilizing Gemma 2 and deterministic heuristics to neutralize prompt injections and redact PII.',
    version: '1.2.0',
...
export const INITIAL_SECURITY_EVENTS: SecurityEvent[] = [
  {
    ...
    shield_engine: 'Gemma-2-Guardrail + Neural Heuristic Shield',
